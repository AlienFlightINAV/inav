...
const timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM2, CH4, PB11, TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 1, 1 ), // S3_OUT - DMA1_ST6
    DEF_TIM(TIM2, CH3, PB10, TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 1, 0 ), // S4_OUT - DMA1_ST1
#else
...
#if defined(FF_FORTINIF4_REV03)
//    DEF_TIM(TIM1, CH3, PA10, TIM_USE_PWM,   0, 0),                        // CAM    - DMA1_ST3
